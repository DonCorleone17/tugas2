...
<html lang="en">
  <head>
    ...
    <title>Checkout Page - BANGSAT.id</title>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="{{ url('/index')}}">Cart - <span class="cart-amunt">$100</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>BANGSAT<span>.id</span></h2>
                        <p>Ku menangis membayangkan Betapa kejamnya dirimu atas diriku. Kau duakan cinta ini Kau pergi bersamanya, hoo-oo. Ku menangis melepaskan Kepergian dirimu dari sisi hidupku. Harus selalu kau tau Akulah hati yang telah kau sakiti</p>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2020 Rizky Orama. All Rights Reserved. 
                    </div>
                </div>
